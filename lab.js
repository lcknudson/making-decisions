...
if(amysAge ==== brittanisAge){
  ...
  console.log('I broke my assignemnt, and my brain.')
}
...
if(rain){
  ...
  console.log('No RAIN, just wear a t-shirt, and some sun shades')
  } else if(temperature >= 60){
  console.log ('No RAIN, wear some flannel and a ball cap')
  } else if(temperature < 60){
  console.log('No RAIN, wear some jeans, hoodie, and beanie.')
}
